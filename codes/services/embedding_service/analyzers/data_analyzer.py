...
class MedicalDataAnalyzer:
    ...
    def load_data(self):
        ...
        # 加载对话数据
        dialogue_train_path = os.path.join(self.data_dir, "dialogue_data", "dialogue_train.csv")
        dialogue_test_path = os.path.join(self.data_dir, "dialogue_data", "dialogue_test.csv")
        ...
        # 加载VQA数据
        vqa_train_path = os.path.join(self.data_dir, "dialogue_data", "vqa_train.csv")
        vqa_test_path = os.path.join(self.data_dir, "dialogue_data", "vqa_test.csv")
