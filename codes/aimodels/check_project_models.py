...
class ProjectModelChecker:
    ...
    def __init__(self, project_root: str = None):
        ...
        self.local_model_paths = {
            "Qwen2-0.5B-Medical-MLX": str(self.project_root / "codes/aimodels/Qwen2-0.5B-Medical-MLX"),
            "text2vec-base-chinese": str(self.project_root / "codes/aimodels/text2vec-base-chinese")
        }
    ...
    def save_report(self, output_path: str = None) -> bool:
        ...
        try:
            if output_path is None:
                output_path = self.project_root / "codes/aimodels/项目模型使用检查报告.md"
