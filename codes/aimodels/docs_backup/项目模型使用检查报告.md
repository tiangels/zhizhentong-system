...
- 🌐 **第39行**: `model_path = Path("aimodels/Medical_Qwen3_17B")`
  - 类型: llm_models
...
- 🌐 **第75行**: `model_path = llm_config.get('model_path', 'aimodels/Medical_Qwen3_17B')`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
- 🌐 **第98行**: `from transformers import AutoTokenizer, AutoModelForCausalLM`
  - 类型: llm_models
  - 模式: `AutoTokenizer`
- 🌐 **第104行**: `model_path = config.get('llm', {}).get('model_path', 'aimodels/Medical_Qwen3_17B')`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
- 🌐 **第55行**: `"text_model_path": "../../../codes/aimodels/text2vec-base-chinese",`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
...
- 🌐 **第13行**: `from transformers import AutoTokenizer, AutoModelForCausalLM, GenerationConfig`
  - 类型: llm_models
  - 模式: `AutoTokenizer`
- 🏠 **第46行**: `self.model_path = config.get('model_path', '/Users/tiangels/AI/llm_learning_project/zhi_zhen_tong_system/codes/aimodels/Medical_Qwen3_17B')`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
- 🌐 **第85行**: `self.model = AutoModelForCausalLM.from_pretrained(`
  - 类型: llm_models
  - 模式: `AutoModelForCausalLM`
- 🌐 **第773行**: `'model_path': 'aimodels/Medical_Qwen3_17B',`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
- 🌐 **第1033行**: `'model_path': 'aimodels/Medical_Qwen3_17B',`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
- 🌐 **第1067行**: `'model_path': 'aimodels/Medical_Qwen3_17B',`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
#### codes/aimodels/check_project_models.py
**状态**: ❌ 需要更新
...
- 🌐 **第54行**: `r"clip-ViT-B-32"`
  - 类型: embedding_models
  - 模式: `clip-ViT-B-32`
- 🌐 **第60行**: `"Medical_Qwen3_17B": str(self.project_root / "codes/aimodels/Medical_Qwen3_17B"),`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
- 🌐 **第61行**: `"text2vec-base-chinese": str(self.project_root / "codes/aimodels/text2vec-base-chinese")`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
...
#### codes/aimodels/model_manager.py
**状态**: ⚠️ 需要更新
...
- 🏠 **第6行**: `"text_model_path": "/Users/tiangels/AI/llm_learning_project/zhi_zhen_tong_system/codes/aimodels/text2vec-base-chinese",`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
- 🌐 **第7行**: `"image_model_path": "clip-ViT-B-32",`
  - 类型: embedding_models
  - 模式: `clip-ViT-B-32`
- 🏠 **第17行**: `"model_name": "/Users/tiangels/AI/llm_learning_project/zhi_zhen_tong_system/codes/aimodels/text2vec-base-chinese"`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
...
- 🌐 **第39行**: `"model_name": "text2vec-base-chinese",`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
- 🏠 **第40行**: `"model_path": "/Users/tiangels/AI/llm_learning_project/zhi_zhen_tong_system/codes/aimodels/text2vec-base-chinese",`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
...
- 🌐 **第6行**: `"model_name": "text2vec-base-chinese",`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
- 🏠 **第7行**: `"model_path": "/Users/tiangels/AI/llm_learning_project/zhi_zhen_tong_system/codes/aimodels/text2vec-base-chinese",`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
...
- 🌐 **第3行**: `"EMBEDDING_MODEL": "shibing624/text2vec-base-chinese",`
  - 类型: embedding_models
  - 模式: `shibing624/text2vec-base-chinese`
- 🏠 **第5行**: `"LOCAL_MODEL_PATH": "/Users/tiangels/AI/llm_learning_project/zhi_zhen_tong_system/codes/aimodels/text2vec-base-chinese",`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`

#### codes/aimodels/text2vec-base-chinese/onnx/config.json
**状态**: ⚠️ 需要更新
...
- 🌐 **第34行**: `MODEL_PATH="aimodels/Medical_Qwen3_17B"`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
- 🌐 **第77行**: `llm_model_path="../../aimodels/Medical_Qwen3_17B"`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
- 🌐 **第22行**: `MODEL_PATH="aimodels/Medical_Qwen3_17B"`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
- 🌐 **第656行**: `# 确保Medical_Qwen3_17B模型已下载到正确位置`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
- 🌐 **第657行**: `# 路径: ../../aimodels/Medical_Qwen3_17B`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
- 🌐 **第660行**: `ls -la ../../aimodels/Medical_Qwen3_17B/`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
- 🌐 **第661行**: `ls -la ../../aimodels/text2vec-base-chinese/`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
...
- 🌐 **第910行**: `- **向量模型**: text2vec-base-chinese`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
- 🌐 **第1111行**: `LLM_MODEL_PATH=aimodels/Medical_Qwen3_17B`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
- 🌐 **第1112行**: `VECTOR_MODEL_NAME=text2vec-base-chinese`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
- 🌐 **第1186行**: `codes/aimodels/text2vec-base-chinese/`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
- 🌐 **第1195行**: `aimodels/Medical_Qwen3_17B/`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
- 🌐 **第1203行**: `- CLIP模型：`clip-ViT-B-32``
  - 类型: embedding_models
  - 模式: `clip-ViT-B-32`
- 🌐 **第1215行**: `"text_model_path": "../../../codes/aimodels/text2vec-base-chinese",`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
...
- 🌐 **第1228行**: `"model_path": "microsoft/DialoGPT-medium",`
  - 类型: llm_models
  - 模式: `microsoft/DialoGPT`
- 🌐 **第1491行**: `"text_model_path": "../../../codes/aimodels/text2vec-base-chinese",`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
- 🌐 **第1511行**: `"model_path": "../../../aimodels/Medical_Qwen3_17B",`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
- 🌐 **第155行**: `- 确保模型路径正确: `aimodels/Medical_Qwen3_17B``
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
- 🌐 **第17行**: `#### Medical_Qwen3_17B`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
- 🌐 **第21行**: `- **路径**: `/Users/tiangels/AI/llm_learning_project/zhi_zhen_tong_system/codes/aimodels/llm_models/Medical_Qwen3_17B``
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
- 🌐 **第25行**: `#### text2vec-base-chinese`
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
- 🌐 **第29行**: `- **路径**: `/Users/tiangels/AI/llm_learning_project/zhi_zhen_tong_system/codes/aimodels/embedding_models/text2vec-base-chinese``
  - 类型: embedding_models
  - 模式: `text2vec-base-chinese`
...
- 🌐 **第173行**: `from transformers import AutoTokenizer, AutoModelForCausalLM`
  - 类型: llm_models
  - 模式: `AutoTokenizer`
- 🌐 **第176行**: `model_path = "codes/aimodels/Medical_Qwen3_17B"`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
- 🌐 **第182行**: `model = AutoModelForCausalLM.from_pretrained(`
  - 类型: llm_models
  - 模式: `AutoModelForCausalLM`
- 🌐 **第207行**: `model_path = "codes/aimodels/Medical_Qwen3_17B"`
  - 类型: llm_models
  - 模式: `Medical_Qwen3_17B`
...
#### codes/aimodels/Qwen3-1.7b-Medical-R1-sft/README.md
**状态**: ⚠️ 需要更新
...
#### codes/aimodels/text2vec-base-chinese/README.md
**状态**: ⚠️ 需要更新
...
#### codes/aimodels/Medical_Qwen3_17B/README.md
**状态**: ⚠️ 需要更新
